...
class Ramulator2 : public AbstractMemory
{
  ...
  protected:
    ...
    struct RamulatorStats : public statistics::Group
    {
      RamulatorStats(statistics::Group *parent);
      statistics::Scalar total_num_write_requests;
      statistics::Scalar total_num_read_requests;
      statistics::Scalar memory_system_cycles;
      
    } stats;
    
    struct RamulatorControllerStats : public statistics::Group
    {
      RamulatorControllerStats(statistics::Group *parent);
      statistics::Scalar avg_read_latency_0;
      statistics::Scalar read_queue_len_avg_0;
      statistics::Scalar write_queue_len_0;
      statistics::Scalar queue_len_0;
      statistics::Scalar num_write_reqs_0;
      statistics::Scalar read_latency_0;
      statistics::Scalar priority_queue_len_avg_0;
      statistics::Scalar row_hits_0;
      statistics::Scalar priority_queue_len_0;
      statistics::Scalar row_misses_0;
      statistics::Scalar row_conflicts_0;
      statistics::Scalar read_row_misses_0;
      statistics::Scalar queue_len_avg_0;
      statistics::Scalar read_row_conflicts_core_0;
      statistics::Scalar read_row_hits_0;
      statistics::Scalar write_queue_len_avg_0;
      statistics::Scalar read_row_conflicts_0;
      statistics::Scalar write_row_misses_0;
      statistics::Scalar write_row_conflicts_0;
      statistics::Scalar read_queue_len_0;
      statistics::Scalar write_row_hits_0;
      statistics::Scalar read_row_hits_core_0;
      statistics::Scalar read_row_misses_core_0;
      statistics::Scalar num_read_reqs_0;
